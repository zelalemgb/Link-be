...
const eventSchema = z.object({
  ...
  frontendReleaseSha: z.string().trim().max(128).optional().nullable(),
  frontendAssetBundle: z.string().trim().max(320).optional().nullable(),
  serviceWorkerState: z.string().trim().max(64).optional().nullable(),
  serviceWorkerScriptUrl: z.string().trim().max(512).optional().nullable(),
  networkOnline: z.boolean().optional().nullable(),
  networkEffectiveType: z.string().trim().max(64).optional().nullable(),
  authBootstrapPhase: z.string().trim().max(64).optional().nullable(),
  scopeSource: z.string().trim().max(64).optional().nullable(),
  requestId: z.string().uuid().optional().nullable(),
  errorFingerprint: z.string().trim().max(256).optional().nullable(),
  failureKind: z.string().trim().max(64).optional().nullable(),
  serverDecisionReason: z.string().trim().max(128).optional().nullable(),
  routeFrom: z.string().trim().max(512).optional().nullable(),
  activeFacilityId: z.string().uuid().optional().nullable(),
  failingChunkUrl: z.string().trim().max(512).optional().nullable(),
  boundaryName: z.string().trim().max(160).optional().nullable(),
  componentStack: z.string().trim().max(4000).optional().nullable(),
